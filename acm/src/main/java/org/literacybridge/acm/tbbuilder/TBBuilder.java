    ...
    private static void printUsage() {
        ...
        String helpStr =
            ...
            "TB-Builder.bat runs " + NL +
                ...
                "    TB-Builder.bat PUBLISH ACM-NAME DEPLOYMENT" + NL + NL +
                "(Usually, the \"language\" and \"group\" are the same. If you need to" + NL +
                "use groups, please contact Amplio in Seattle for detailed instructions.)" + NL + NL +
